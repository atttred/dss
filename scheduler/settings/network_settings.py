class NetworkSettings:
    ...
    NUMBER_OF_REQUESTS = [0, 1] # List of numbers of requests created in one time
    WEIGHTS = [0.1, 0.9] # List of weights (chances) for the NUMBER_OF_REQUESTS value to be chosen.
